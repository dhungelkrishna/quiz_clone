		...
		<main>
			<div class="container">
				...
				<ul>
				    ...
				    <li><strong>Estimated time for each question: </strong><?php echo $total * 0.1 * 40; ?> seconds</li>
				     <li><strong>Score: </strong>   &nbsp; +1 point for each correct answer</li>
				</ul>
				<a href="question.php?n=1" class="start">PHP-Quiz</a>
